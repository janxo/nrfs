...
// ზოგიერთ სის-ქოლში ვიყენებ
typedef struct {
	int packet_size;	// გამოგზავნილი პაკეტის ზომა
	status st;		// სტატუს კოდი
	char buff[BUFF_len];	// ბაფერი
} response_t;
```
...
ყველა სისტემ ქოლის მოთხოვნები იგზავნება თითოეულ სერვერზე read გარდა, რომელიც მხოლოდ მთავარ სერვერზე იგზავნება,
...
თუ კავშირის აღდგენა მოხერხდა მაშინ ამ სერვერზე ფაილები აღდგება იმ მომენტში, როდესაც ამ ფაილების გახსნა მოხდება კლიენტის მიერ. (თუ MAIN სერვერთან მოხდა კავშირის გაწყვეტა მაშინ აღდგენისას ახალი ჩაწერილი ფაილები ჩვეულებრივად გამოჩნდება ls დროს, რადგან დირექტორიები ორივე სერვერიდან მომაქვს და იბეჭდება იმ სერვერიდან ინფორმაცია რომელზეც უფრო მეტი ობიექტი იყო).
